...
The source code developed in the course of this thesis was entirely written in Python 3.11.11 \parencite{ref:python} and can be accessed \hrefu{https://github.com/hauser-group}{online} \parencite{ref:hauser-group-github}.
