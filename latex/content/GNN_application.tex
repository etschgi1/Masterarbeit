...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{l
            ...
            \midrule
            $\text{GNN}_\text{initial}$  & \textbf{11.2(5)}  & -1230(30) & -0.703(10) & 0.204(15)  & \textbf{0.0078(6)}\\
            $\text{GNN}_\text{aug. 1.5}$ & 11.2(6)           & -1240(40) & -0.707(10) & 0.206(16)& 0.0079(6)\\
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{l
                        ...
                        $\text{GNN}_\text{dist. thres. 2.5}$ & \textbf{11.2(5)} & -1230(30) & -0.71(11) & 0.204(15)& 0.0081(6)\\
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrrrrr}
        ...
        Hidden Dimension & 512 & 256 & 128 & 128 & 128 & 512 & 256 & 128 & 256 & 256 \\
        Batch Size & 8 & 8 & 8 & 8 & 32 & 32 & 32 & 32 & 32 & 32 \\
        Data aug. & 1.8284 & 2.4589 & 2.3841 & 1.7602 & 1.4980 & 1.1408 & 1.6722 & 2.4478 & 1.9081 & 2.3284 \\
        Edge thres. & 2.7331 & 3.8705 & 3.2133 & 2.0669 & 2.1125 & 2.1070 & 2.1384 & 2.1235 & 2.1113 & 2.0468 \\
        Message p. steps & 2 & 4 & 3 & 3 & 4 & 2 & 3 & 2 & 3 & 3 \\
        Message Net Dropout & 0.1039 & 0.2664 & 0.2111 & 0.1760 & 0.2946 & 0.1403 & 0.1834 & 0.2280 & 0.2191 & 0.1080 \\
        Message Net Layers & 3 & 5 & 4 & 3 & 5 & 3 & 3 & 3 & 5 & 3 \\
        Learn Rate & 0.0006 & 0.0002 & 0.0003 & 0.0049 & 0.0040 & 0.0002 & 0.0004 & 0.0044 & 0.0003 & 0.0001 \\
        Weight Decay & 0.0005 & 0.0001 & 0.0000 & 0.0000 & 0.0010 & 0.0001 & 0.0001 & 0.0000 & 0.0003 & 0.0000 \\
        \bottomrule
        \end{tabular}
        }
\end{table}
