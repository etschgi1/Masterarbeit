...
\begin{table}[h]
    \centering
    \caption[GNN predictions on QM9 isomers MD]{GNN predictions on the QM9 isomer MD test set. With MD-retrained versions of $\text{GNN}_\text{initial}$ and $\text{GNN}_\text{f. 0}$.}
...
\begin{table}[H]
    \centering
    \caption[GNN on QM9 isomers MD training with full matrix loss]{GNN on QM9 isomers MD using full matrix loss to train. \TODO{how choosen}}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{l
            ...
            $\text{GNN}^{\text{MD}}_\text{f. 0}$      & 11.1(5)  & -1250(40) & -0.706(10)       & 0.213(14)& 0.0073(5) \\
            best MD model &&&&&\\
            maybe other notable md model &&&&&\\
            $\overline{P}$                & 16.9(10) & -202(3)     & -0.11(0)    & 0.012(0) & 0.0134(3) \\
            ...
            \texttt{minao}                & 10.7(5)  & 2.96(4)     & 0.001673(8) & 0.077(3) & 0.01538(18) \\
            \bottomrule
        \end{tabular}
    }
\end{table}
\section{QM9 - stratified sample}
\label{sec:qm9_isomers_benchmark}
