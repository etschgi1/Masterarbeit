...
\def\mykeywordsabstract{computational quantum chemistry $\cdot$ machine learning $\cdot$ graph neural network $\cdot$ initial guess prediction $\cdot$ density functional theory $\cdot$ self-consistent field}
\hypersetup{
