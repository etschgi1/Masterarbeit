...
def load_cached(file_paths, cache_path, basis, guess="minao", method="dft", functional="b3lypg", backend="pyscf", early_stopping=100):
    error_list = []
    error_files = []
    focks = []
    used_files = []
    ...
    for file in file_paths:
        ...
        if early_stopping and len(focks) >= early_stopping: 
            break
...
ret = load_cached(all_file_paths, "../../datasets/QM9/out/c7h10o2_b3lypg_6-31G(2df" \
",p)/pyscf", basis="6-31g_2df_p_custom_nwchem.gbs")
print(ret[0][0].shape)